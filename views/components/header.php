                ...
                <div class="reg">
                    <?php if (isset($_SESSION['user_name'])) : ?>
                        <p class="mb-0">
                            ...
                            <a href='../views/user/logout.php'>Cerrar sesión</a>
                        </p>
                    <?php else : ?>
                        <p class="mb-0">
                            <a href='../views/user/login_register.php' class="mr-2">Registrarse</a>
                            <a href='../views/user/login_register.php'>Iniciar sesión</a>
                        </p>
                    <?php endif; ?>
                </div>
            </div>
